            ...
            <div class="col-lg-12">
                <form id="reservation-form" name="gs" method="POST" role="search" action="{{ route('traveling.reservation.store', $city->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                <label for="days" class="form-label">days of your holiday</label>
                                <input type="text" name="days" class="days" value="{{$days}}" autocomplete="on" readonly>
                            </fieldset>
                        </div>

                        <div class="col-lg-6">
                            <fieldset>
                                <label for="tourGuide" class="form-label">Your tour Guide</label>
                                <input type="text" name="tourGuide" class="tourGuide" value="{{$tourGuide->name}}" autocomplete="on" readonly>
                                <input type="hidden" name="tourGuide_id" class="tourGuide_id" value="{{$tourGuide->id}}">

                            </fieldset>
                        </div>
                        <div class="col-lg-6">
                            <fieldset>
                                <label for="guide_type" class="form-label">Your tour Guide status</label>
                                <input type="text" name="guide_type" class="guide_type" value="{{$guide_type}}" autocomplete="on" readonly>
                            </fieldset>
                        </div>
                        <div class="col-lg-12">
                            <fieldset>
